...
public class NotificationUtils {
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        //For Android O this is required
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel mChannel = new NotificationChannel(Integer.toString(WATER_REMINDER_NOTIFICATION_ID),
        ...
        NotificationCompat.Builder notificationBuilder =
                ...
                .setAutoCancel(true);
        //Jelly bean to O priority is set to high
