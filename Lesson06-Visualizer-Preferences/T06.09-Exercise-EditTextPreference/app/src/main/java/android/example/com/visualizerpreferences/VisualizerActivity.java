...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        getSizeFromSharedPreferences(sharedPreferences);
    ...
    private void getSizeFromSharedPreferences(SharedPreferences preferences){
        float minSize = Float.parseFloat(preferences.getString(getString(R.string.pref_size_key),getString(R.string.pref_size_default)));
